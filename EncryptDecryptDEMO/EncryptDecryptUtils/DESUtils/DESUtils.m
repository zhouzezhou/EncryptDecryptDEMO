...
+ (NSString *)DESEncryptByString:(NSString *)str WithKey:(NSString *)key
{
    ...
    NSData *encryptData = [self DESEncrypt:d WithKey:key];
...
{
    NSData *tempData = [[NSData alloc] initWithBase64EncodedString:str options:0];
    NSData *desDecryptData = [self DESDecrypt:tempData WithKey:key];
    return [[NSString alloc] initWithData:desDecryptData encoding:NSUTF8StringEncoding];
}
